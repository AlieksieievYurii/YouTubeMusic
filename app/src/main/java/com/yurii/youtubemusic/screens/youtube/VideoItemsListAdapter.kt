...
class VideoItemsListAdapter : PagingDataAdapter<VideoItem, VideoItemsListAdapter.MyViewHolder>(Comparator) {
    ...
    inner class MyViewHolder(val binding: ItemVideo2Binding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(data: VideoItem) {
            binding.videoItem = data
            expandItem(this, expandedItem == data, animate = false)
